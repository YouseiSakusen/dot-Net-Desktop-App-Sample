...
public class CharacterRepositoryLite : IRepositoryLite
{
	...
	public UnitOfWork Unit { get; init; }

	public CharacterRepositoryLite(DapperWrapper dapperWrapper, UnitOfWork unitOfWork)
		=> (this.Dapper, this.Unit) = (dapperWrapper, unitOfWork);
